...
def generate_definitions_lines(textEntries):
	yield "// Text Definitions generated by text-process\n"
	yield "// Do not edit!\n\n"

	yield "#ifndef TEXT_DEFINITIONS\n"
	yield "#define TEXT_DEFINITIONS\n\n"
